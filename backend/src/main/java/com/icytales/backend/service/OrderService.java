...
public class OrderService {
    ...
    public List<CustomerOrder> findMine(String email) { return orderRepository.findAllByUserEmailIgnoreCaseOrderByCreatedAtDesc(email); }
    public CustomerOrder findMineByOrderNumber(String number, String email) {
        return orderRepository.findByOrderNumberAndUserEmailIgnoreCase(number, email)
